    ...
    public class FirstPersonPerspectiveItem : PerspectiveItem
    {
        ...
        public Spring PositionSpring { get { return m_PositionSpring; }
            set {
                ...
                if (m_PositionSpring != null) { m_PositionSpring.Initialize(false, true); RefreshSprings(); }
            }
        }
        ...
        { get { return m_PositionOffset; }
            set {
                ...
                if (m_PositionSpring != null) { RefreshSprings(); }
            }
        }
        ...
        public Vector3 RotationOffset { get { return m_RotationOffset; } set { m_RotationOffset = value; if (m_RotationSpring != null) { RefreshSprings(); } } }
        public Vector3 RotationExitOffset { get { return m_RotationExitOffset; } set { m_RotationExitOffset = value; if (m_RotationSpring != null) { RefreshSprings(); } } }
        public Spring RotationSpring { get { return m_RotationSpring; }
            set {
                m_RotationSpring = value;
                if (m_RotationSpring != null) { m_RotationSpring.Initialize(true, true); RefreshSprings(); }
            }
        }
        ...
        public Spring PivotPositionSpring { get { return m_PivotPositionSpring; }
            set {
                ...
                if (m_PivotPositionSpring != null) { m_PivotPositionSpring.Initialize(false, true); RefreshSprings(); }
            }
        }
        ...
        { get { return m_PivotPositionOffset; }
            set {
                ...
                if (m_PivotPositionSpring != null) { RefreshSprings(); }
            }
        }
        public Spring PivotRotationSpring { get { return m_PivotRotationSpring; }
            set {
                m_PivotRotationSpring = value;
                if (m_PivotRotationSpring != null) { m_PivotRotationSpring.Initialize(true, true); RefreshSprings(); }
            }
        }
        ...
        public override void Initialize(GameObject character)
        {
            ...
            if (m_Object == null) {
                ...
                var parent = GetSpawnParent(m_Item.SlotID, true);
        ...
        protected override Transform GetSpawnParent(int slotID, bool parentToItemSlotID)
        {
